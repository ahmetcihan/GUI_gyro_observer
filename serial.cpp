...
void MainWindow::serial_response_handler(void){
    ...
    if((data_array[0] == 'G') && (data_array[1] == 'Y') && (data_array[2] == 'R')){
        ...
        qDebug() << "GYRO status :" << QString::number((u8)data_array[9],2) << "ACC status :" << QString::number((u8)data_array[16],2);
        ...
        ui->label_mag_x->setText("ACC X : " + QString::number(MAG_x));
        ui->label_mag_y->setText("ACC Y : " + QString::number(MAG_y));
        ui->label_mag_z->setText("ACC Z : " + QString::number(MAG_z));
        plot_graph();
    }
}
